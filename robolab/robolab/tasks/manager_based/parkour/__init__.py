...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.mini3_parkour_env_cfg:MINI3ParkourEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.mini3_parkour_agent_cfg:MINI3ParkourAmpRunnerCfg",
    },
)

gym.register(
    id="MINI3-Parkour-Play",
    entry_point="robolab.tasks.manager_based.parkour.parkour_env:ParkourEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.mini3_parkour_env_cfg:MINI3ParkourEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.mini3_parkour_agent_cfg:MINI3ParkourAmpRunnerCfg",
    },
)