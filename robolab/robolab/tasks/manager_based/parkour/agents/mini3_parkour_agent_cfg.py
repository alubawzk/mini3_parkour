...
from robolab.tasks.manager_based.parkour.mdp.symmetry import mini3 as symmetry
...
@configclass
class MINI3ParkourAmpRunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "AMPRunner"
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 1000
    experiment_name = "mini3_parkour"
    wandb_project = "mini3_parkour"
    obs_groups = {
        "policy": ["policy"],
        "critic": ["critic"],
        "discriminator": ["disc"],
